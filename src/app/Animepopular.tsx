...
export const AnimePopular = ()=>{
    ...
    return(
        <div className="min-h-screen flex justify-center mt-8 md:mt-18 lg:mt-32 p-4 md:p-8 ">
            <div className="w-[90%] h-180 bg-secondary-background border-2 brutal-hover p-4">
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 flex items-center justify-center rounded-full bg-accent-lightRed">
                        <IconBook width={30} height={30} color="black"/>
                    </div>  
                    <h2 className="text-3xl border-b-[3px] border-b-accent-lightRed pb-1 w-fit">Explore Anime Collections</h2>
                </div>
